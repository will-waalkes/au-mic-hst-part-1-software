...
fit_info = retriever.get_default_fit_info(
    ...
    logZ=1., log_cloudtop_P=4, cloud_frac=1.,
...
with open(pfolder+'aumicb_nlive1000_contam_newdataDec28_errinfl_widerMpPrior_newT.pkl', "wb") as f:
    pickle.dump(result, f)

plotter = Plotter()
plotter.plot_retrieval_transit_spectrum(result, prefix=pfolder+
                                        'aumicb_nlive1000_contam_newdataDec28_errinfl_widerMpPrior_newT')
plotter.plot_retrieval_corner(result, filename=pfolder+
                              'aumicb_nlive1000_contam_newdataDec28_errinfl_widerMpPrior_newT_corner.pdf')
