...
with open(pfolder+'aumicb_nlive1000_contam_newdataDec28_errinfl_flatline.pkl', "wb") as f:
    pickle.dump(result, f)

plotter = Plotter()
plotter.plot_retrieval_transit_spectrum(result, prefix=pfolder+
                                        'aumicb_nlive1000_contam_newdataDec28_errinfl_flatline')
plotter.plot_retrieval_corner(result, filename=pfolder+
                              'aumicb_nlive1000_contam_newdataDec28_errinfl_flatline_corner.pdf')
